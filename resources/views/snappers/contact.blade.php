...
<section>
    ...
    <form>
      ...
      <dl>
        ...
        <dd>
          ...
          <datalist id="type">
            <option value="01">撮影のご依頼</option>
            <option value="02">講演・各種メディア出演のご依頼</option>
            <option value="03">その他お問い合わせ</option>
          </datalist>
        </dd>
        <dt>ご希望のご連絡方法</dt>
        <dd>
  ...
  <a href="{{route('snappers.download')}}"><span id="download"></span></a>
</section>
@endsection
